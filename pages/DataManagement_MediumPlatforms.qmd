...
* [NextSeek](https://github.com/BMCBCC/NExtSEEK)
    ...
    + Wrapper on [Seek](DataManagement_MajorPlatforms.qmd?#life-science), so the Seek API is still usable. It seems to be an additional API for NextSeek but we couldn't find a documentation.
